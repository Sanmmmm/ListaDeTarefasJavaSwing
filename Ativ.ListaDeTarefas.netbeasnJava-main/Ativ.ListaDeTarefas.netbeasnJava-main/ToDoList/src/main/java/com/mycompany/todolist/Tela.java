...
public class Tela extends javax.swing.JFrame {
 private final ArrayList<String> tasks = new ArrayList<>();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         String novaTarefa = jTextField1.getText();
    if (!novaTarefa.isEmpty()) {
        tasks.add(novaTarefa); // Adiciona a tarefa à lista
        listModel.addElement(novaTarefa); // Adiciona a tarefa à JList
        jTextField1.setText(""); // Limpa o campo de texto
    }// TODO add your handling code here:
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
         tasks.clear();
        listModel.clear();// TODO add your handling code here:
